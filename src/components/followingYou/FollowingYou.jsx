...
import { followRequest } from '../../redux/actions/userAction'
                    ...
                    <div className='d-flex align-items-center justify-content-between my-2'>
                        ...
                        </div>
                        {
                            otherUserRequestMe == undefined ?
                                <button className='same-btn same-btn-hover py-1 px-1 border-radius10' style={{ fontSize: "14px", width: "100px" }} onClick={() => followRequestFun(props.id)}><span style={{ fontSize: "13px" }}>Follow</span></button>
                                :
